...
curl 'http://localhost:8081/restaurants/commands/sign-up' \
  --data '{"email":"vini@gmail.com"}' \
  -H 'Content-Type:application/json'
echo

curl 'http://localhost:8081/restaurants/463cf7a3-d158-5e5d-a06e-28ae5eacf6c9/addresses/commands/add' \
...
curl 'http://localhost:8081/restaurants/1740f165-2d30-9670-5ef0-8a0a3c0fe78f/addresses/commands/add' \
